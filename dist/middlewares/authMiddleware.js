    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                verified = jsonwebtoken_1["default"].verify(token, validateEnvs_1["default"].JWT_SECRET);
                return [4 /*yield*/, userModel_1["default"].findById(verified._id).select("-password")];
            case 1:
                user = _a.sent();
                if (!user) {
